// Vercel serverless function: fetches a public match log page server-side.
// This is what makes "paste a link" work — browsers can't fetch other sites
// directly (CORS), but a server can.
...
export default async function handler(req, res) {
  ...
  // Only allow tennisrungs.com to keep this from being an open proxy
  ...
  try {
    ...
    // Cache identical requests for 5 minutes so repeat lookups are instant
